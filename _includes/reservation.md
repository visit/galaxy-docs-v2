...
--------- | -----------
BookingCode | The code representing the reservation returned from <a href="https://visit.github.io/galaxy-docs-v2/#commit-status">Commit Status</a> 
...
This will cancel a reservation. Similarly to commiting a Basket, it reurns an integer. Use this value in <a href="https://visit.github.io/galaxy-docs-v2/#commit-status">Commit Status</a> to see the status of your cancel job
